			...
			<main className="flex flex-1 flex-col">
				<section className="py-8">
					<div className="flex items-center justify-between">
						...
						<Image
							...
							width={85}
							height={85}
							className="rounded-full filter grayscale hover:grayscale-0 transition-all duration-300 cursor-pointer"
						/>
					</div>
				</section>
					...
					<div className="space-y-6">
						...
						<div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
							<p>
								...
								applications , infastructure and distributed systems.
							</p>
							<p>
				...
				<section className="py-10">
					<div className="space-y-6">
						...
						<ul className="space-y-3 text-gray-600 dark:text-gray-400 leading-relaxed list-disc list-inside">
							{[
