...
import LoadingLink from "@/components/common/loading-link";
			...
			<div className="mx-auto w-full  px-4 sm:px-0 py-6">
				<div className="flex flex-col md:flex-row md:justify-between md:space-y-0 space-y-8">
					<div className="flex flex-col items-start space-y-4">
						...
						<p className="text-left text-sm text-foreground/70">
				...
				<div className="mx-auto w-full px-4 md:px-0">
					<div className="mt-12 flex flex-col md:flex-row md:justify-between items-center border-t border-border/40 pt-8 gap-4">
						...
						<div className="flex space-x-6">
							{[
								{
									href: "https://twitter.com/siralcntra",
									label: "X",
								...
								},
								{
									...
									label: "Email",
									icon: "M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-.904.732-1.636 1.636-1.636h20.728c.904 0 1.636.732 1.636 1.636zM7.227 8.795L12 12.5l4.773-3.705L12 4.5 7.227 8.795z",
								},
							].map(({ href, label, icon }) => (
								<Link
									key={label}
