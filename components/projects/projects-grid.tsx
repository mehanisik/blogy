		...
		<MotionContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 py-8 min-h-[72vh]">
			{projects?.map((project) => (
				<Link
					...
					className="block"
				>
					<MotionCard className="h-full flex flex-col relative bg-card/50 backdrop-blur-sm border border-border/40 rounded-xl p-6 transition-all duration-500 ease-out cursor-pointer">
